function navbar() {
    ...
    const html = `<a href="/" class="text-[#c8c8c8] text-base font-bold font-['Raleway'] hover:text-[#01aae8]">Beranda </a>
          <a class="text-[#c8c8c8] text-base font-bold font-['Raleway'] hover:text-[#01aae8]">Catalogue</a>
          ...
          <a class="text-[#c8c8c8] text-base font-bold font-['Raleway'] hover:text-[#01aae8]">Wishlist</a>`;
